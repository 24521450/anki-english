...
Public tools, pipeline dependencies, and tools referenced by current source or
project documentation must remain in `tools/` and use `src.config.ProjectPaths`.
Historical regression tests may import archived modules directly when they
characterize retired behavior.
