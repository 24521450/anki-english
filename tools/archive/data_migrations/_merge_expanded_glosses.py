...
Workflow:
  ...
  3. They run the archived merge tool to write the
...
Usage:
  python -m tools.archive.data_migrations._merge_expanded_glosses --dry-run
  python -m tools.archive.data_migrations._merge_expanded_glosses --expanded path/to/expanded.jsonl
  python -m tools.archive.data_migrations._merge_expanded_glosses --master path/to/master.jsonl
