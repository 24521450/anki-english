...
Historical regression tests may import archived helper modules directly to keep
old behavior characterized without keeping those commands in the active
...
2. Move only one-shot or retired-data scripts to `tools/archive/data_migrations/`.
